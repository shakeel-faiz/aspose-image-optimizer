...
function ConvToWebP_DirectoryScanner(totalSteps, currentStep) {
    ...
    const obj = {
        scan() {
            ...
            if (currentStep != 0) {
                ...
                jQuery.post(ajaxurl, {
                    action: 'directory_aiconvtowebp_start'
                }, function() {
    ...
    const step = function(remainingSteps) {
        ...
        if (remainingSteps > 0) {
            ...
            return jQuery.post(ajaxurl, {
                action: 'directory_aiconvtowebp_check_step',
                step: currentStep
            }, function(response) {
        ...
        return jQuery.post(ajaxurl, {
            action: 'directory_aiconvtowebp_finish',
    ...
    WP_AIConvToWebP.directory = {
        ...
        init() {
            ...
            $("#ChooseDirModal .aspimgconv-box-footer-btn").on('click', function() {
                ...
                const param = {
                    action: 'aiconvtowebp_image_list',
                    aiconv_path: paths,
                };
                ...
                $.post(ajaxurl, param, function(response) {
                    ...
                    if (response.success) {
                        ...
                        let scanner = new ConvToWebP_DirectoryScanner(response.data,0);
                        scanner.scan();
                    } else {
